...
The neighborhood size of z_i^Local and z_i^Global is determined by the manually set kNN parameter k.  
For example, if the local neighborhood uses k = 12, then the local neighborhood size is L = 13, including the spot itself and its 12 neighboring spots.
